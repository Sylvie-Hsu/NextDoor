...
//this assure it's runned before any behaviour that may use it, as the animator need to be fecthed
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        float proximityBeforeChangeDestination = 3.0f;
        ...
        private void FixedUpdate()
        {
            ...
            // if (!m_NavMeshAgent.pathPending && m_NavMeshAgent.remainingDistance < proximityBeforeChangeDestination && !pursuiting)
            // {
            //     SetNextDestination();
            // }
        }
        ...
        {
            m_NavMeshAgent.SetDestination(patrolPoints[patrolPointIndex].position);//Destination
