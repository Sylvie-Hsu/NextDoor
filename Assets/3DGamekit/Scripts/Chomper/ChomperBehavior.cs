...
namespace Dream
{
    ...
    public class ChomperBehavior : MonoBehaviour, IMessageReceiver
    {
        ...
        private void FixedUpdate()
        {
            ...
            m_Controller.animator.SetBool(hashNearBase, false);//toBase.sqrMagnitude < 0.1 * 0.1f);
        }
        ...
        public void WalkBackToBase()
        {
            ...
            Vector3 toBase = originalPosition - transform.position;
            toBase.y = 0;
            if(toBase.sqrMagnitude < 0.3 * 0.3f){
                originalPosition=m_Controller.patrolPoints[m_Controller.patrolPointIndex].position;
                m_Controller.patrolPointIndex=(m_Controller.patrolPointIndex + 1) % m_Controller.patrolPoints.Length;
            }
